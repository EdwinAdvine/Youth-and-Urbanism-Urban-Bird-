...
const TYPE_ICONS: Record<string, React.ReactNode> = {
  welcome: <Heart size={16} className="text-pink-500" />,
  order_placed: <ShoppingBag size={16} className="text-blue-500" />,
  order_confirmed: <CheckCheck size={16} className="text-green-500" />,
  order_dispatched: <Package size={16} className="text-orange-500" />,
  order_out_for_delivery: <Package size={16} className="text-yellow-600" />,
  order_delivered: <CheckCheck size={16} className="text-green-600" />,
  thank_you: <Heart size={16} className="text-pink-500" />,
};
    ...
    <div className="max-w-2xl mx-auto px-4 py-8">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-xl font-bold font-lexend text-gray-900">Notifications</h1>
          {unreadCount > 0 && (
